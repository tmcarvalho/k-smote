...
import gc
import pika
from PrivateSMOTE_force import PrivateSMOTE_force_
from PrivateSMOTE import PrivateSMOTE_
...
def do_work(conn, ch, delivery_tag, body):
    ...
    if args.type == 'PrivateSMOTE':
        work_sucess = PrivateSMOTE_(msg)
    if args.type == 'PrivateSMOTE_force':
        work_sucess = PrivateSMOTE_force_(msg)
    gc.collect()
...
channel.basic_consume('task_queue_privatesmote_force', on_message_callback)
...
# python3 code/transformations/task_privateSMOTE.py  --input_folder "original" 
# python3 code/transformations/worker_privateSMOTE.py --type "PrivateSMOTE"
# python3 code/transformations/worker_privateSMOTE.py --type "PrivateSMOTE_force"