...
plt.figure(figsize=(6,4))
sns.set_style("darkgrid")
ax4 = sns.boxplot(x=privsmote_ds16["Range Coverage"], hue=privsmote_ds16[r'$\epsilon$'], hue_order=hue_order)
sns.move_legend(ax4, bbox_to_anchor=(1,0.5), loc='center left', borderaxespad=0., frameon=False)
sns.set(font_scale=1)
sns.set_palette("Paired")
...
plt.figure(figsize=(6,4))
sns.set_style("darkgrid")
ax4 = sns.boxplot(x=privsmote_ds16["Statistic Similarity (Mean)"], hue=privsmote_ds16[r'$\epsilon$'], hue_order=hue_order)
sns.move_legend(ax4, bbox_to_anchor=(1,0.5), loc='center left', borderaxespad=0., frameon=False)
sns.set(font_scale=1)
sns.set_palette("Paired")
