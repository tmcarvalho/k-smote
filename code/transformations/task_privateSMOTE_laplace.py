...
def put_file_queue(ch, file_name):
    ...
    ch.basic_publish(
        exchange='',
        routing_key='task_queue_privatesmote_force_laplace',
        body=file_name,
...
channel.queue_bind(exchange='dlx', routing_key='task_queue_privatesmote_force_laplace', queue=dl_queue.method.queue)
