...
# python3 code/modeling/task.py  --input_folder "output/oversampled/PrivateSMOTE5"
...
# python3 code/modeling/worker.py --type "PrivateSMOTE" --input_folder "output/oversampled/PrivateSMOTE5" --output_folder "output/modeling/PrivateSMOTE5"
